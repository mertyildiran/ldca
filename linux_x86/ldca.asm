...
rand_byte:      mov     ebx, program            ; Move the cursor to the beginning of the program
                rndNum  0, programsize          ; generate random number between 0 and "programsize"
...
shrink_loop:    rndNum  1, esi                  ; Delete offset, between 1 and "current programsize"
...
shrink:         rndNum  1, programsize          ; Shrink size, between 1 and "programsize"
                push    eax                     ; push the shrink size into the stack
